...
int _commandSet(int*, char*, int*, Mode);
int _commandGuess(int*, char*, int*, Mode);
int _commandGenerate(int*, char*, int*, Mode);
int _commandHint(int*, char*, int*, Mode);

State readCommand(Sudoku *sudoku, char *input);
void _parseCommand(char*, int*, char**, Mode, int*);
int numberOfCells();
